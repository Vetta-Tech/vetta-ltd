...
class Contact extends Component<ContactProps> {
  render() {
    ...
    return (
      <div>
        <Navbar />
        <section className="relative bg-black pt-20 font-monster 2xl:pt-40">
          <div className="absolute top-0 right-0 hidden h-full w-1/2 bg-gray-900 lg:block" />
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-5xl">
              <div className="-mx-4 flex flex-wrap">
                <div className="relative w-full overflow-hidden px-4 pb-20 lg:w-1/2">
                  <img
                    className="absolute bottom-0 right-0 -mr-20 -mb-52 hidden h-screen w-full lg:block"
                    src="https://shuffle.dev/zospace-assets/lines/circle.svg"
                    alt=""
                  />
                  <img
                    className="absolute bottom-0 right-0 -mr-52 -mb-64 hidden lg:block"
                    src="https://shuffle.dev/zospace-assets/lines/circle.svg"
                    alt=""
                  />
                  <div className="relative max-w-md">
                    <div className="mb-8 border-b border-gray-400 pb-16">
                      <span className="text-lg font-bold text-blue-400">
                        Have a question?
                      </span>
                      <h2 className="font-heading mt-10 mb-16 text-5xl font-bold text-white">
                        Contact with us
                      </h2>
                ...
                <div className="relative w-full px-4 pb-20 lg:w-1/2">
                  <div className="max-w-md lg:ml-20">
                    <form action="#">
                      ...
                      <input
                        className="mb-3 w-full rounded-full bg-white px-12 py-4 font-bold placeholder-gray-900 focus:outline-none"
                        type="email"
                        placeholder="care@vetta.app"
                      />
                      <input
                        className="mb-3 w-full rounded-full bg-white px-12 py-4 font-bold placeholder-gray-900 focus:outline-none"
                        type="text"
                      ...
                      />
                      <textarea
                        className="mb-6 w-full resize-none rounded-3xl bg-white px-12 py-4 font-bold placeholder-gray-900 focus:outline-none"
                        cols={30}
                        rows={10}
                      ...
                      <div className="mb-10 flex">
                        <input type="checkbox" />
                        <p className="max-w-xs pl-4 text-sm text-gray-300">
                          By singning up, you agree to our Terms, Data Policy
                          and Cookies.
                        </p>
                      </div>
                      <button className="rounded-full bg-blue-500 py-4 px-12 font-bold text-white transition duration-200 hover:bg-blue-600">
                        Send message
                      </button>
                    </form>
                  </div>
