...
class Faq extends Component<ContactProps> {
  render() {
      ...
      <div>
        ...
        <section className="py-8">
          <div className="container mx-auto px-4">
            <div className="mb-8 rounded bg-red-500 p-8">
              <div className="-mx-4 flex flex-wrap items-center">
                <div className="w-full px-4 lg:w-2/3">
                  <h2 className="text-3xl font-bold text-white">
                    Are you looking sdfsdf answers?
                  </h2>
                  <p className="text-indigo-50">
                    We have prepared the most frequently asked questions for you
                  </p>
                </div>
                <div className="flex w-full items-center px-4 lg:w-1/3">
                  <img src="artemis-assets/images/office.png" alt="" />
                </div>
              </div>
            </div>
            <div className="-mx-4 flex flex-wrap">
              <div className="mb-8 w-full px-4 lg:mb-0 lg:w-3/12">
                <div className="rounded bg-white p-2">
                  <ul className="text-sm">
                    <li>
                      <a
                        className="flex items-center rounded bg-indigo-50 p-3 font-medium text-indigo-500"
                        href="#"
                      >
                        <span className="mr-3">
                          <svg
                    ...
                    <li>
                      <a
                        className="flex items-center rounded p-3 font-medium text-gray-500 hover:bg-indigo-50 hover:text-indigo-500"
                        href="#"
                      >
                        <span className="mr-3">
                          <svg
              ...
              <div className="w-full px-4 lg:w-9/12">
                <div className="mb-8 flex items-center px-3">
                  <span className="mr-4 inline-flex h-16 w-16 items-center justify-center rounded bg-indigo-500">
                    <svg
                      width={30}
                      height={30}
                      viewBox="0 0 30 30"
                ...
                <ul>
                  <li className="mb-3 rounded bg-white py-5 px-6 shadow">
                    ...
                    <p className="mt-3 hidden pr-6 text-sm text-gray-500">
                      ...
                      condimentum bibendum. Donec convallis tellus sem, at
                      lobortis nulla sagittis in. Proin facilisis a enim eget
                      luctus. Sed et maximus libero. Nulla pellentesque
                      imperdiet neque vitae fringilla.
                    </p>
                  </li>
                  <li className="mb-3 rounded bg-white py-5 px-6 shadow">
                    <button className="flex w-full items-center justify-between">
