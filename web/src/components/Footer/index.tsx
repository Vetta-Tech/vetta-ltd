...
export default function Footer() {
  return (
    <div>
      <div className="relative flex justify-start font-monster text-xs md:items-end md:justify-center ">
        <img
          ...
          alt="background"
        />
        <div className="relative z-10 flex flex-col items-start justify-start px-4 pt-36 font-monster  text-xs md:items-center md:justify-center md:px-6 md:pt-32 lg:pt-40 xl:px-20 xl:pt-96">
          <div className="flex  flex-col items-start justify-start xl:flex-row xl:justify-center xl:space-x-8">
            ...
            <div className="mt-12 grid w-full grid-cols-1 gap-y-12 font-monster text-xs sm:grid-cols-3 sm:gap-y-0 sm:gap-x-20 md:w-auto md:gap-x-28 xl:mt-0 xl:gap-8">
              <div className="flex flex-col items-start justify-start space-y-6 sm:w-40 md:w-auto xl:w-72">
                <h2 className="text-xs font-bold leading-4 text-white xl:text-xl xl:font-semibold xl:leading-5">
                  Community
                </h2>
                <button className="text-left text-xs leading-none text-gray-100 hover:text-gray-400">
                  About Us
                </button>
                <button className="text-left text-xs leading-none text-gray-100 hover:text-gray-400">
                ...
                <button className="text-left font-monster text-xs leading-none text-gray-100 hover:text-gray-400">
                  How to start a blog
                </button>
              </div>
              <div className="flex flex-col items-start justify-start space-y-6 sm:w-40 md:w-auto xl:w-72">
          ...
          <div className="mt-12 flex  w-full flex-col-reverse items-center xl:flex-row xl:items-start xl:justify-between ">
            ...
            <div className="mt-10 flex w-full flex-col items-start justify-start space-y-4 md:mt-12 md:w-auto md:flex-row md:items-center md:justify-center md:space-y-0 md:space-x-4 xl:mt-0 xl:space-x-6">
              <button className="text-xs leading-none text-white hover:text-gray-300">
                Terms of service
              </button>
              <button className="text-xs leading-none text-white hover:text-gray-300">
                Privacy Policy
